...
export const Welcome = () => (
  <svg fill="none" viewBox="0 0 769 193" className="invert-on-dark">
    ...
    <path fill="#000" d={WELCOME_BACK}></path>
    <path
      fill="#EEE"
      fillRule="evenodd"
